...
world = {
  "uuid": "4CEEB42F-62F7-4D3A-AF28-C71267036240",
  "name": "Zork",
  "creator": "Twine",
  "creatorVersion": "2.3.14",
  "schemaName": "Harlowe 3 to JSON",
  "schemaVersion": "0.0.6",
  "createdAtMs": 1630639112906,
  "passages": [
    {
      "name": "West of House",
      "tags": "",
...
def get_input():
	return input("Where would you like to go? ").strip().upper()

def update(current_location, location_label, response):
    if "links" in current_location:
    	for link in current_location["links"]:
    		if response in link["linkText"]:
    			location_label = link["passageName"]
